...
var l5B=_mz(z,'uni-swipe-action',['bind:__l',2,'class',1,'vueId',2,'vueSlots',3],[],e,s,gg)
var a6B=_v()
_(l5B,a6B)
var t7B=function(b9B,e8B,o0B,gg){
var oBC=_mz(z,'uni-swipe-action-item',['bind:__l',10,'bind:change',1,'bind:click',2,'class',3,'data-event-opts',4,'options',5,'vueId',6,'vueSlots',7],[],b9B,e8B,gg)
_(o0B,oBC)
return o0B
}
a6B.wxXCkey=4
...
var fCC=_mz(z,'view',['bindtap',19,'class',1,'data-event-opts',2],[],e,s,gg)
var cDC=_mz(z,'dragball',['bind:__l',22,'image',1,'vueId',2,'x',3,'y',4],[],e,s,gg)
_(fCC,cDC)
_(o2B,fCC)
c3B.wxXCkey=1
c3B.wxXCkey=3
...
var cGC=_mz(z,'uni-swipe-action',['bind:__l',1,'vueId',1,'vueSlots',2],[],e,s,gg)
var oHC=_v()
_(cGC,oHC)
var lIC=function(tKC,aJC,eLC,gg){
var oNC=_mz(z,'uni-swipe-action-item',['bind:__l',8,'bind:change',1,'bind:click',2,'class',3,'data-event-opts',4,'options',5,'vueId',6,'vueSlots',7],[],tKC,aJC,gg)
_(eLC,oNC)
return eLC
}
oHC.wxXCkey=4
...
_(oFC,cGC)
var xOC=_mz(z,'view',['bindtap',16,'class',1,'data-event-opts',2],[],e,s,gg)
var oPC=_mz(z,'dragball',['bind:__l',19,'image',1,'vueId',2,'x',3,'y',4],[],e,s,gg)
_(xOC,oPC)
_(oFC,xOC)
_(r,oFC)
return r
...
var z=gz$gwx_19()
var cRC=_mz(z,'t-table',['bind:__l',0,'bind:change',1,'border',1,'borderColor',2,'data-event-opts',3,'isCheck',4,'vueId',5,'vueSlots',6],[],e,s,gg)
var hSC=_v()
_(cRC,hSC)
var oTC=function(oVC,cUC,lWC,gg){
var tYC=_mz(z,'t-tr',['align',12,'bind:__l',1,'color',2,'fontSize',3,'vueId',4,'vueSlots',5],[],oVC,cUC,gg)
var eZC=_mz(z,'t-td',['align',18,'bind:__l',1,'vueId',2,'vueSlots',3],[],oVC,cUC,gg)
_(tYC,eZC)
_(lWC,tYC)
return lWC
}
...
__wxAppCode__['app.json']={"pages":["pages/index/index","pages/index/404","pages/index/payload/payload","pages/index/About","pages/index/check","pages/index/login","pages/index/tableList","pages/index/swipe-action","pages/index/payload/payload","pages/index/centerPay/centerPay"],"window":{"style":{"app-plus":{"titleNView":false}},"navigationBarTextStyle":"black","navigationBarTitleText":"uni-app","navigationBarBackgroundColor":"#F8F8F8","backgroundColor":"#F8F8F8"},"tabBar":{"color":"#2C405A","selectedColor":"#1296db","borderStyle":"black","backgroundColor":"#FFFFFF","list":[{"pagePath":"pages/index/index","iconPath":"static/work4.png","selectedIconPath":"static/work2.png","text":"工作台"},{"pagePath":"pages/index/check","iconPath":"static/check2.png","selectedIconPath":"static/check1.png","text":"治疗登记"},{"pagePath":"pages/index/centerPay/centerPay","iconPath":"static/pay4.png","selectedIconPath":"static/pay.png","text":"确认收费"}]},"nvueCompiler":"uni-app","renderer":"auto","splashscreen":{"alwaysShowBeforeRender":true,"autoclose":false},"appname":"app","compilerVersion":"2.4.6","usingComponents":{}};
...
__wxAppCode__['pages/index/centerPay/centerPay.json']={"titleNView":false,"usingComponents":{}};
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/index"],{5844:function(n,t,e){},7053:function(n,t,e){"use strict";e.r(t);var a=e("f604"),o=e.n(a);for(var r in a)"default"!==r&&function(n){e.d(t,n,function(){return a[n]})}(r);t["default"]=o.a},9321:function(n,t,e){"use strict";var a=function(){var n=this,t=n.$createElement;n._self._c},o=[];e.d(t,"a",function(){return a}),e.d(t,"b",function(){return o})},"96b6":function(n,t,e){"use strict";e.r(t);var a=e("9321"),o=e("7053");for(var r in o)"default"!==r&&function(n){e.d(t,n,function(){return o[n]})}(r);e("bc38");var u=e("2877"),c=Object(u["a"])(o["default"],a["a"],a["b"],!1,null,null,null);t["default"]=c.exports},bc38:function(n,t,e){"use strict";var a=e("5844"),o=e.n(a);o.a},f0cb:function(n,t,e){"use strict";(function(n){e("22cd"),e("921b");a(e("66fd"));var t=a(e("96b6"));function a(n){return n&&n.__esModule?n:{default:n}}n(t.default)}).call(this,e("6e42")["createPage"])},f604:function(n,t,e){"use strict";(function(n,e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a={data:function(){return{backOrder:"",no:"登录",yes:""}},onShow:function(){var t=this;n.getStorage({key:"loginUser",success:function(n){t.yes=n.data}});var e={name:"张三"},a={age:18};for(var o in a)!0===a.hasOwnProperty(o)&&(e[o]=a[o]);var r=[2,3,4,5,6,7];r.forEach(function(n,t,e){})},methods:{back:function(){var t=this;n.showModal({title:"提示",content:"确认退出吗?",success:function(a){a.confirm?(n.setStorage({key:"loginUser",data:t.backOrder}),n.showToast({title:"退出成功",duration:2e3}),n.reLaunch({url:"./login"})):a.cancel&&console.log(e("取消退出登录"," at pages\\index\\index.vue:107"))}})},loginOr:function(){this.yes||n.reLaunch({url:"./login"})}}};t.default=a}).call(this,e("6e42")["default"],e("0de9")["default"])}},[["f0cb","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/payload/payload"],{2934:function(t,e,n){"use strict";n.r(e);var i=n("72bc"),o=n.n(i);for(var a in i)"default"!==a&&function(t){n.d(e,t,function(){return i[t]})}(a);e["default"]=o.a},"31f3":function(t,e,n){},"4d59":function(t,e,n){"use strict";var i=n("31f3"),o=n.n(i);o.a},"72bc":function(t,e,n){"use strict";(function(t,i){function o(t,e){return u(t)||s(t,e)||a()}function a(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}function s(t,e){var n=[],i=!0,o=!1,a=void 0;try{for(var s,u=t[Symbol.iterator]();!(i=(s=u.next()).done);i=!0)if(n.push(s.value),e&&n.length===e)break}catch(l){o=!0,a=l}finally{try{i||null==u["return"]||u["return"]()}finally{if(o)throw a}}return n}function u(t){if(Array.isArray(t))return t}Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var l=function(){return n.e("components/drag-ball/drag-ball").then(n.bind(null,"f0e5"))},c=function(){return n.e("components/uni-section/uni-section").then(n.bind(null,"6ef2"))},r=function(){return n.e("components/uni-swipe-action/uni-swipe-action").then(n.bind(null,"8d42"))},d=function(){return Promise.all([n.e("common/vendor"),n.e("components/uni-swipe-action-item/uni-swipe-action-item")]).then(n.bind(null,"fec3"))},p={components:{uniSection:c,uniSwipeAction:r,uniSwipeActionItem:d,dragball:l},data:function(){return{loginyes:!1,loginNo:!1,stepperList:[{id:10},{id:20}],arrs:[],e:[],m:[],pc:[],isOpened:!1,left:290,top:500,timeOnce:"",number:"",values:"",checkone:"",quantity:1,options1:[{text:"取消置顶"}],options2:[{text:"取消",style:{backgroundColor:"#007aff"}},{text:"确认",style:{backgroundColor:"#dd524d"}}],swipeList:[],newSwiplist:[]}},onReady:function(){var t=this;this.$nextTick(function(){t.isOpened=!0})},onLoad:function(t){this.checkone=t.checkone,this.projectCode=t.projectCode},onShow:function(){var e=this;t.getStorage({key:"loginUser",success:function(t){e.yes=t.data}}),this.yes?(this.loginyes=!0,this.loginNo=!1):this.yes||(this.loginyes=!1,this.loginNo=!0),t.getStorage({key:"somebody",success:function(t){e.newSwiplist=t.data}})},methods:{addNum:function(e){for(var n=0;n<this.newSwiplist.length;n++){var i=[];i.push(this.newSwiplist[e])}++i[0].quantity,t.setStorage({key:"somebody",data:this.newSwiplist})},deleteNum:function(e){for(var n=0;n<this.newSwiplist.length;n++){var i=[];i.push(this.newSwiplist[e])}i[0].quantity<=1?i[0].quantity=1:i[0].quantity>1&&--i[0].quantity,t.setStorage({key:"somebody",data:this.newSwiplist})},value:function(t){this.number=t.target.value},centerOk:function(){var e=this;t.showModal({title:"提示",content:"是否提交缴费",success:function(n){n.confirm?(t.showToast({title:"提交成功",duration:2e3}),e.newSwiplist=[],t.setStorage({key:"somebody",data:e.newSwiplist}),e.number=""):n.cancel&&console.log(i("用户点击取消"," at pages\\index\\payload\\payload.vue:210"))}})},code:function(){var e=this;t.scanCode({success:function(t){console.log(i("条码内容："+t.result," at pages\\index\\payload\\payload.vue:265")),e.number=t.result}})},add:function(){var e=this;this.number?this.number&&t.request({url:"http://192.168.0.114:8888/api/app/confirmCharging/GetChargeRefundList?kewWord="+this.number+"&beginDate=1899-01-01&endDate=2000-10-01",method:"GET"}).then(function(n){var a=o(n,2),s=(a[0],a[1]);if(console.log(i(s.data," at pages\\index\\payload\\payload.vue:284")),e.newSwiplist=s.data,null!=e.newSwiplist&&""!=e.newSwiplist&&e.newSwiplist){for(var u={},l=[],c=0;c<e.newSwiplist.length;c++)u=Object.assign({options:[{text:"删除",style:{backgroundColor:"rgb(255,58,49)"}}]},e.newSwiplist[c]),l.push(u);e.newSwiplist=l,t.setStorage({key:"somebody",data:e.newSwiplist}),e.number=""}else t.showToast({title:"暂无患者信息",duration:1e3})}):t.showToast({title:"请输入用户信息",duration:1e3})},listItem:function(){},back:function(){t.reLaunch({url:"../centerPay/centerPay"})},bindClick:function(e){t.showToast({title:"点击了".concat(e.content.text,"按钮"),icon:"none"})},setOpened:function(){this.isOpened=!this.isOpened},change:function(t){this.isOpened=t,console.log(i("返回：",t," at pages\\index\\payload\\payload.vue:337"))},swipeChange:function(t){console.log(i("返回：",t," at pages\\index\\payload\\payload.vue:340"))},swipeClick:function(e,n){var o=this,a=e.content;"删除"===a.text?t.showModal({title:"提示",content:"是否删除",success:function(e){e.confirm?(o.newSwiplist.splice(n,1),t.setStorage({key:"somebody",data:o.newSwiplist})):e.cancel&&console.log(i("用户点击取消"," at pages\\index\\payload\\payload.vue:357"))}}):"添加"===a.text?this.newSwiplist.length<100?(this.newSwiplist.push({id:(new Date).getTime(),options:[{text:"置顶"},{text:"标记为已读",style:{backgroundColor:"rgb(254,156,1)"}},{text:"删除",style:{backgroundColor:"rgb(255,58,49)"}}],content:"新增"}),t.showToast({title:"添加了一条数据",icon:"none"})):t.showToast({title:"最多添加一百条条数据",icon:"none"}):t.showToast({title:"点击了".concat(e.content.text,"按钮"),icon:"none"})}}};e.default=p}).call(this,n("6e42")["default"],n("0de9")["default"])},"811d":function(t,e,n){"use strict";n.r(e);var i=n("9f72"),o=n("2934");for(var a in o)"default"!==a&&function(t){n.d(e,t,function(){return o[t]})}(a);n("4d59");var s=n("2877"),u=Object(s["a"])(o["default"],i["a"],i["b"],!1,null,null,null);e["default"]=u.exports},8752:function(t,e,n){"use strict";(function(t){n("22cd"),n("921b");i(n("66fd"));var e=i(n("811d"));function i(t){return t&&t.__esModule?t:{default:t}}t(e.default)}).call(this,n("6e42")["createPage"])},"9f72":function(t,e,n){"use strict";var i=function(){var t=this,e=t.$createElement;t._self._c},o=[];n.d(e,"a",function(){return i}),n.d(e,"b",function(){return o})}},[["8752","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/About"],{"076b":function(t,n,e){"use strict";var u=function(){var t=this,n=t.$createElement;t._self._c},r=[];e.d(n,"a",function(){return u}),e.d(n,"b",function(){return r})},"0dba":function(t,n,e){"use strict";e.r(n);var u=e("076b"),r=e("ec83");for(var a in r)"default"!==a&&function(t){e.d(n,t,function(){return r[t]})}(a);e("9687");var o=e("2877"),c=Object(o["a"])(r["default"],u["a"],u["b"],!1,null,null,null);n["default"]=c.exports},"4bdb":function(t,n,e){},"508a":function(t,n,e){"use strict";(function(t){e("22cd"),e("921b");u(e("66fd"));var n=u(e("0dba"));function u(t){return t&&t.__esModule?t:{default:t}}t(n.default)}).call(this,e("6e42")["createPage"])},"5f14":function(t,n,e){"use strict";Object.defineProperty(n,"__esModule",{value:!0}),n.default=void 0;var u={data:function(){return{orderNo:5340}},methods:{}};n.default=u},9687:function(t,n,e){"use strict";var u=e("4bdb"),r=e.n(u);r.a},ec83:function(t,n,e){"use strict";e.r(n);var u=e("5f14"),r=e.n(u);for(var a in u)"default"!==a&&function(t){e.d(n,t,function(){return u[t]})}(a);n["default"]=r.a}},[["508a","common/runtime","common/vendor"]]]);
});
...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/login"],{"49ec":function(e,t,n){"use strict";n.r(t);var a=n("8e8e"),o=n.n(a);for(var r in a)"default"!==r&&function(e){n.d(t,e,function(){return a[e]})}(r);t["default"]=o.a},5285:function(e,t,n){},"8e8e":function(e,t,n){"use strict";(function(e,n){function a(e,t){return u(e)||r(e,t)||o()}function o(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}function r(e,t){var n=[],a=!0,o=!1,r=void 0;try{for(var u,i=e[Symbol.iterator]();!(a=(u=i.next()).done);a=!0)if(n.push(u.value),t&&n.length===t)break}catch(c){o=!0,r=c}finally{try{a||null==i["return"]||i["return"]()}finally{if(o)throw r}}return n}function u(e){if(Array.isArray(e))return e}Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var i={data:function(){return{secrect:"",account:"",employeeName:""}},onShow:function(){var t=this;e.setStorage({key:"loginUser",data:t.employeeName})},onLoad:function(){},methods:{onSecrectInput:function(e){this.secrect=e.target.value},onAccountInput:function(e){this.account=e.target.value},submitClick:function(){var t=this;e.request({url:"http://192.168.0.114:9904/api/user/Verify?username="+this.account+"&pwd="+this.secrect+"&token=1"}).then(function(e){var t=a(e,2);t[0],t[1]}),e.request({url:"http://192.168.0.114:8888/api/basic/clinicdata/employee/"+this.account+"/code",method:"GET"}).then(function(o){var r=a(o,2),u=(r[0],r[1]);console.log(n(u.data," at pages\\index\\login.vue:76")),t.employeeName=u.data.employeeName,e.setStorage({key:"loginUser",data:u.data.employeeName});var i=null;clearTimeout(i),u.data.employeeName?(e.showToast({title:"登录成功",duration:1e3}),i=setTimeout(function(){e.reLaunch({url:"./index"})},2e3)):u.data.employeeName||e.showToast({title:"登录失败，请稍后重试！！",duration:2e3})})}}};t.default=i}).call(this,n("6e42")["default"],n("0de9")["default"])},"904a":function(e,t,n){"use strict";var a=function(){var e=this,t=e.$createElement;e._self._c},o=[];n.d(t,"a",function(){return a}),n.d(t,"b",function(){return o})},ce3e:function(e,t,n){"use strict";(function(e){n("22cd"),n("921b");a(n("66fd"));var t=a(n("ed96"));function a(e){return e&&e.__esModule?e:{default:e}}e(t.default)}).call(this,n("6e42")["createPage"])},ed96:function(e,t,n){"use strict";n.r(t);var a=n("904a"),o=n("49ec");for(var r in o)"default"!==r&&function(e){n.d(t,e,function(){return o[e]})}(r);n("f91a");var u=n("2877"),i=Object(u["a"])(o["default"],a["a"],a["b"],!1,null,null,null);t["default"]=i.exports},f91a:function(e,t,n){"use strict";var a=n("5285"),o=n.n(a);o.a}},[["ce3e","common/runtime","common/vendor"]]]);
});
...
require('pages/index/payload/payload.js');
__wxRoute = 'pages/index/centerPay/centerPay';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/index/centerPay/centerPay.js';

define('pages/index/centerPay/centerPay.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
...
require('pages/index/centerPay/centerPay.js');
;(function(global) {
